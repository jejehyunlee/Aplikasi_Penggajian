	...
	<div class="container-fluid">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="no-dropdown"><a href="<?php echo site_url('/back_office/pengguna'); ?>">pengguna</a></li>
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#"><?php echo $this->session->userdata('pengguna');?> <span class="caret"></span></a>
